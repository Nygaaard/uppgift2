...
},{"./displaydata":"hot54","./addData":"3Zind","./deleteData":"a8klx"}],"hot54":[function(require,module,exports) {
...
async function displayData() {
    ...
    experiences.forEach((item)=>{
        ...
        deleteBtn.addEventListener("click", async ()=>{
            try {
                const success = await (0, _deleteData.deleteExperienceFromDatabase)(item.id);
...
},{"./getdata":"c3fXv","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./deleteData":"a8klx"}],"c3fXv":[function(require,module,exports) {
...
async function deleteExperienceFromDatabase(id) {
    try {
        const response = await fetch(`http://localhost:3000/api/workexperience/${id}`, {
            method: "DELETE"
        });
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["j2YDk","1SICI"], "1SICI", "parcelRequirea041")
